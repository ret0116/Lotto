...
object LottoNumberMaker {
    ...
    fun getRandomLottoNumbers(): MutableList<Int> {
        ...
        for (i in 1..6) {
            ...
            do {
                ...
                // lottoNumbers 에 number 번수의 값이 없을때까지 반복
    ...
    fun getRandomLottoNumber(): Int {
        ...
        // 1 ~ 45 까지의 번호를 생성하려면 파라미텉의 45를 넣고 결과값에 1을 더한다.
    ...
    fun getLottoNumbersFromHash(str:String): MutableList<Int> {
        ...
        // SEED값은 전달받는 이름과 오늘에 해당하는 "yyyy-MM-dd"를 합친 문자열의 해시코드를 사용한다.
